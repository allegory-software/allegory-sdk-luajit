...
#define I256_GT_64_MASK(x, y) (uint64_t)_mm256_movemask_pd(_mm256_castsi256_pd(_mm256_cmpgt_epi64(x, y)))
#define I256_AND(o, x, y) o = _mm256_and_si256(x, y)
#define I256_ANDNOT(o, x, y) o = _mm256_andnot_si256(x, y) /* ~x & y */
#define I256_XOR(o, x, y) o = _mm256_xor_si256(x, y)
#define I256_OR(o, x, y) o = _mm256_or_si256(x, y)
#define I256_BCAST8(o, v) o = _mm256_set1_epi8(v)
#define I256_BCAST64(o, v) o = _mm256_set1_epi64x(v)
#define I256_LOADU(o, ptr) o = _mm256_loadu_si256((__m256i *)ptr)
#define I256_LOADA(o, ptr) o = _mm256_load_si256((__m256i *)ptr)
#define I256_STOREU(ptr, v) _mm256_storeu_si256((__m256i *)ptr, v)
